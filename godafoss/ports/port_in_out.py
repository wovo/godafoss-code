...
class port_in_out( gf.autoloading ):
    """
    ...
    def __init__(
        ...
        gf.autoloading.__init__( self, port_in_out )
        self.number_of_pins = number_of_pins

    # =======================================================================

    #def inverted( self ) -> "gf.port_in_out":
    #    return gf._port_in_out_inverted( self )
    ...
    #    return gf._port_in_out_mirrored( self )
    ...
    #    return gf._port_in_out_as_port_in( self )

    # =======================================================================

    #def as_port_out( self ) -> "gf.port_out":
    #    return gf._port_in_out_as_port_out( self )
    ...
    #    return gf._port_in_out_as_port_oc( self )
