...
class edge( 
    ...
    def _init_pins(
        ...
        try:
            ...
            port_in_out.__init__( self, self.pins )
            return
    ...
    def _init_pins_from_uname(
        ...
        if uname[ 0 ] == "rp2":
            ...
            if uname[ 4 ] == "ESP32C3 module with ESP32C3":
                ...
                result = _edge_esp32_lolin_c3_mini()
    ...
    def _edge_rp2(
        ...
        v = pin_adc( 28 ).read().scaled( 0, 65535 )

        # 10k, 10k
        if within( v, 31000, 35000 ):
    ...
    def spi(
        ...
        mode: int = 0,
        mechanism: int = 1,
        implementation: int = spi_implementation.soft,
        id: int = None
    ):
        return spi(
            sck = self.spi_sck,
