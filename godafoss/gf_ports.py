...
class port_in_out(
    ...
    def directions_set_input(
        ...
        self.directions_set( invert_bits( 0, self.number_of_pins ) )
...
def _make_masks(
    ...
    myself._mask = 0x01 << n
    myself._inverted_mask = invert_bits(
        myself._mask,
