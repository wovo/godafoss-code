...
class UC8151:
    ...
    def set_panel_configuration(
        ...
        self.write( UC8151._commands.PSR, psr_settings )
    ...
    def initialize_display(
        ...
        # Soft reset
        self.write( UC8151._commands.PSR, RESET_SOFT )
        ...
        self.write( UC8151._commands.BTST, [ boost_value ] * 3 )

        # Power on
        self.write( UC8151._commands.PON )
        ...
        self.write( UC8151._commands.TCON, 0x22 )
        ...
        print( "set PLL" )
        self.write( UC8151._commands.PLL, UC8151._pll.f_100 )

        # Power off the display. We will pover on it again on the
        # next update of the image.
        self.write( UC8151._commands.POF )
    ...
    def set_waveform_lut(
        ...
        self.write( UC8151._commands.LUT_VCOM, VCOM )
        self.write( UC8151._commands.LUT_BW, BW )
        self.write( UC8151._commands.LUT_WB, WB )
        self.write( UC8151._commands.LUT_WW, WW )
        self.write( UC8151._commands.LUT_BB, BB )
    ...
    def update(
        ...
        self.send_image(fb)
        self.write( UC8151._commands.DRF ) # Start refresh cycle.
    ...
    def send_image(
        ...
        self.write( UC8151._commands.PON ) 
        self.write( UC8151._commands.PTOU )
        
        if old:
            # Transfer to previous image buffer.
            self.write( UC8151._commands.DTM1,fb )
            
        else:
            # Transfer to current image buffer.
            self.write( UC8151._commands.DTM2,fb ) 
            
        # End of data    
        self.write( UC8151._commands.DSP )
    ...
    def update_greyscale(
        self,
        buffer,
        greyscale = 32
    ) -> None:
    
        greyscales = [32,16,8,4] # Must be powers of 2.
