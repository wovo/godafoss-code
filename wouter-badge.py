...
def draw_badge():
    ...
    display.text("Wouter", LEFT_PADDING, (COMPANY_HEIGHT // 2) + 1, WIDTH, 1.4)
    ...
    display.text( "MicroPython", 50, HEIGHT - ((DETAILS_HEIGHT * 3) // 2), WIDTH, 0.6 )
    ...
    display.text( "C++", 50, HEIGHT - (DETAILS_HEIGHT // 2), WIDTH, 0.8 )
    
    jpeg.open_file("/badges/snake2.jpg")
    jpeg.decode( 1, HEIGHT - 64 )
    
    jpeg.open_file("/badges/c++.jpg")
    jpeg.decode( 10, HEIGHT - 31 )
